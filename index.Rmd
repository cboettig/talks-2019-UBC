...
- Is forward-looking, dynamic (Ecosystem services take time to establish)
- Balance costs of adopting DFS with benefits of ecosystem services

]
.pull-right[

![](../image-library/royalsociety/balance.jpg)

```{r}
#ggimage("../image-library/royalsociety/balance.jpg")
```

### Utility

Individual utility reflects individual values, objectives, social, ecological, and economic context
...
Higher investment in diversified pratices drives gradual improvement in ecosystem services

- higher biodiversity, 
- improved pest control, 
- higher weed control and soil health, 
...
- long-term yield improvement, reduced fertilizer and machinery input, higher profitability and less risk
...
## Tipping Point Dynamics in Diversfied Farming Systems?
...
```{r}
sims <- read_tsv("../../boettiger-lab/dfs-mdp/data/fig2.tsv.gz")
sim_plot(sims)
...
```{r}
read_tsv("../../boettiger-lab/dfs-mdp/data/fig3A.tsv.gz") %>%
  sim_plot("2-year, large subsidy")
```
...
read_tsv("../../boettiger-lab/dfs-mdp/data/fig3B.tsv.gz") %>%
  sim_plot("10-year, small subsidy")
```
